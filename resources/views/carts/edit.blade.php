                    ...
                    <form action="{{ route('carts.update', $cart->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('recipe_name') is-invalid @enderror"
                                name="item" value="{{ old('item', $cart->item) }}" placeholder="Input item">
                        ...
                        <div class="form-group my-4">
                            ...
                            <input type="text" class="form-control @error('note') is-invalid @enderror"
                                name="quantity" value="{{ old('item', $cart->quantity)}}" placeholder="Input quantity">
                        ...
                        <div class="form-group my-4">
                            ...
                            <input type="text" class="form-control @error('note') is-invalid @enderror"
                                name="status" value="{{ old('item', $cart->status)}}" placeholder="Input status">
                        ...
                        <button type="submit" class="btn my-4 btn-md btn-primary">UPDATE</button>
